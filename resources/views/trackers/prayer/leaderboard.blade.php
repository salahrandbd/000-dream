    ...
    <div class="row flex-column flex-md-row align-items-center my-3">
      <div class="col-12 col-md-8 mb-2 mb-md-0">
        <h5 class="page-title text-uppercase fw-semibold mb-0 text-center text-md-start">
          Salah Leaderboard
          <span data-bs-toggle="tooltip" data-bs-placement="top" title="Based on the statistics from {{ Carbon::parse($startDate)->format('M d, Y') }} to {{ Carbon::parse($endDate)->format('M d, Y') }} prioritizing fard success rate, sunnah success rate, other rak'ats count and subscription duration in sequence" class="cursor-pointer"><i class="bi bi-info-circle-fill"></i></span>
        </h5>
      </div>
